/* The same Lucide icon set the desktop app uses (ported from timber/ui/icons.py)
   so the web matches the desktop exactly. Rendered as inline SVG, currentColor. */
...
const PATHS: Record<string, string> = {
  ...
  // theme toggle (not in the desktop set — standard Lucide moon/sun)
